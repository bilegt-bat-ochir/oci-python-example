...
# ---- usage syntax
def usage():
    print (f"Usage: {sys.argv[0]} [-a] -p default")
    print ( "")
...
def generate_html_table_exadatainfrastructures():
    print ("    <table>")
    print (f"        <caption>ExaCC Exadata infrastructures in tenant <b>{tenant_name.upper()}</b> on <b>{now}</b></caption>")
    my_str = """        <tbody>
            <tr>
                <th>Region</th>
                <th>Compartment</th>
...
def generate_html_table_vmclusters():
    print ("    <table>")
    print (f"        <caption>ExaCC VM clusters in tenant <b>{tenant_name.upper()}</b> on <b>{now}</b></caption>")
    my_str = """        <tbody>
            <tr>
                <th>Region</th>
                <th>Compartment</th>
...
def generate_html_table_autonomousvmclusters():
    print ("    <table>")
    print (f"        <caption>ExaCC autonomous VM clusters in tenant <b>{tenant_name.upper()}</b> on <b>{now}</b></caption>")
    my_str = """        <tbody>
            <tr>
                <th>Region</th>
                <th>Compartment</th>
...
now = datetime.utcnow().strftime("%c")+" UTC"
