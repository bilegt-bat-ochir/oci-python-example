...
# Specifically this scripts lists GI and OS versions
...
#    2022-05-05: Matthieu: changes the original script to show GI and OS versions
# --------------------------------------------------------------------------------------------------------------
...
def vmcluster_print_details (vmcluster_id, lcpt_name):
    ...
    # print details
    print (f"{config['region']}, {lcpt_name}, {vmcluster.display_name}, {vmcluster.lifecycle_state}, {vmcluster.gi_version}, {vmcluster.system_version}")
...
# -- Columns title
print ("Region, Compartment, Name, Status, GI Version, Exadata Image Version")
